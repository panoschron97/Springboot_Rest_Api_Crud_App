...
public class InformationServicelmpl implements InformationService
{
    ...
    {
        Optional<Information> information = Optional.ofNullable(informationrepository.selectInformationById(id));/*.findById(id);*/
    ...
    public List<Object/*Information*/> findAllInformation()
    {
        ...
        return informationrepository.selectInformation();/*.findAll();*/
